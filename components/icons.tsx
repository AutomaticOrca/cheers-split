...
export const LinkedinIcon: React.FC<IconSvgProps> = () => {
    return (
        <svg fill="#0072b1" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
            <path
...
export const UserMinusIcon: React.FC<IconSvgProps> = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"
             className="size-6">
            <path strokeLinecap="round" strokeLinejoin="round"
...
export const BinIcon: React.FC<IconSvgProps> = () => {
    return (
        <svg className="size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
             stroke="currentColor"
        >
            <path strokeLinecap="round" strokeLinejoin="round"
